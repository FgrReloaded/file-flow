...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/fgrreloaded/.vscode/extensions/wallabyjs.console-ninja-1.0.369/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2081b4a66445794119fe6bDR9bAk8HDABWDAEOBVABDwRWUFFa', mode: 'build'}); } catch(cjsError) { try { import('file:///home/fgrreloaded/.vscode/extensions/wallabyjs.console-ninja-1.0.369/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2081b4a66445794119fe6bDR9bAk8HDABWDAEOBVABDwRWUFFa', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
